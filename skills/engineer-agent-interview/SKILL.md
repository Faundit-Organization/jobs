---
name: engineer-agent-interview
version: 1.1.0
description: Interview the human about their AI coding setup and produce a markdown artifact that describes their AI agent profile. Use when applying to a role that asks for evidence of AI-native working habits, or when instructed to "run the grill" / "produce your AI setup artifact".
---
...
_Skill version: [the version from this skill's frontmatter]_
